...
export default function RecordModal({ editing, form, saving, onChange, onClose, onSubmit }) {
  ...
  return (
    <ModalShell as="form" busy={saving} onClose={onClose} onSubmit={onSubmit} labelledBy="record-modal-title">
      <div className="modal-head">
        <div>
          <h2 id="record-modal-title">{editing ? "Edit record" : "Add record"}</h2>
