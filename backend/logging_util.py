...
ACTION_CATALOG = {
    ...
    "case.create": {"module": "cases", "label": "Case created", "resource_type": "case"},
    "case.update": {"module": "cases", "label": "Case updated", "resource_type": "case"},
    "case.status": {"module": "cases", "label": "Case status updated", "resource_type": "case"},
    "case.delete": {"module": "cases", "label": "Case deleted", "resource_type": "case"},
    "case.file.upload": {"module": "cases", "label": "Case file uploaded", "resource_type": "case"},
    "case.file.delete": {"module": "cases", "label": "Case file deleted", "resource_type": "case"},
    "case.import": {"module": "cases", "label": "Cases imported", "resource_type": "case"},
    ...
    "lcl.import": {"module": "lcl", "label": "LCL volume imported", "resource_type": "lcl"},
    "icb.import": {"module": "icb", "label": "ICB stations imported", "resource_type": "icb"},
    "icb.create": {"module": "icb", "label": "ICB station created", "resource_type": "icb"},
    "icb.update": {"module": "icb", "label": "ICB station updated", "resource_type": "icb"},
    "icb.delete": {"module": "icb", "label": "ICB station deleted", "resource_type": "icb"},
    "unloco.import": {"module": "unloco", "label": "UNLOCODE imported", "resource_type": "unloco"},
    "unloco.create": {"module": "unloco", "label": "UNLOCODE created", "resource_type": "unloco"},
    "unloco.update": {"module": "unloco", "label": "UNLOCODE updated", "resource_type": "unloco"},
    "unloco.delete": {"module": "unloco", "label": "UNLOCODE deleted", "resource_type": "unloco"},
...
FAILURE_LABELS = {
    ...
    "case.create": "Case create failed",
    "case.update": "Case update failed",
    "case.status": "Case status update failed",
    "case.delete": "Case delete failed",
    "case.file.upload": "Case file upload failed",
    "case.file.delete": "Case file delete failed",
    "case.import": "Case import failed",
    ...
    "lcl.import": "LCL volume import failed",
    "icb.import": "ICB import failed",
    "icb.create": "ICB create failed",
    "icb.update": "ICB update failed",
    "icb.delete": "ICB delete failed",
    "unloco.import": "UNLOCODE import failed",
    "unloco.create": "UNLOCODE create failed",
    "unloco.update": "UNLOCODE update failed",
    "unloco.delete": "UNLOCODE delete failed",
